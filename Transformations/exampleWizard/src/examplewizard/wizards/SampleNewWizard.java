...
public class SampleNewWizard extends Wizard implements INewWizard {
	...
	private void doFinish(
		...
		monitor.beginTask("Creating project from " + fileName, 2);
		IWorkspaceRoot root = ResourcesPlugin.getWorkspace().getRoot();
		
		main.Main.main(new String[]{fileName});
...
//		});
	...
	private void throwCoreException(String message) throws CoreException {
		IStatus status =
			new Status(IStatus.ERROR, "exampleWizard", IStatus.OK, message, null);
